...
public:
		...
		:Layer("Example"), m_Camera(-1.6f, 1.6f, -0.9f, 0.9f), m_CameraPosition(0.0f)
	{
		...
		squareVB->SetLayout({
			{ Jona::ShaderDataType::Float3, "a_Position" },
			{ Jona::ShaderDataType::Float2, "a_TexCoord" }
			});
		...
		m_FlatColorShader.reset(Jona::Shader::Create(flatColorShaderVertexSrc, flatColorShaderFragmentSrc));

		m_TextureShader.reset(Jona::Shader::Create("assets/shaders/Texture.glsl"));
